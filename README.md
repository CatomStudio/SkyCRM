声明：
	此项目源码由园友处Fork而来，仅供个人参考和学习。

teaCRM
======

我开发的灵活、高效、强大的CRM系统。
使用Spring .NET、ASP .NET MVC、ELinq作为基本项目架构，
同时使用Unit Test单元测试、Glimpse作为性能测试、Log4Net日志记录、MySql作为数据库、T4模板代码自动生成、Bootstrape作为前端框架，
适合大型企业多用户、高并发、高性能、基于云平台。
